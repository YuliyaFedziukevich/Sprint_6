...
* 1 Выпадающий список в разделе «Вопросы о важном»: 
* - helper/answers_text.py,
* - helper/url,
* - locators/important_questions_locators.py, pages/important_questions_pages.py, test_important_questions.py
* 2 Заказ самоката:
* - helper/test_data.py, helper/url,
* -  locators/ordering_scooter_locators.py, pages/ordering_scooter_pages.py, test/test_ordering_scooter.py
...
* - test_data.py - содержит тестовые данные для оформления заказа самоката;
